...
import { OmitRecursive, tryGet } from "@/libs/utils";
import type { WithAny } from "@/types/common";

import { useCtfRichTextHyperlinkQuery } from "./__generated/richtext-ctf-component-feature.generated";
...
export type RichtextCtfComponentFeatureProps = WithAny & {
  json: any;
  links?: {
    entries?: {
      block?: any;
...
/**
 * Renders the rich text `contentful` feature component.
...
const RichtextCtfComponentFeature = (
  ...
  const { json, links, containerClassName, gridClassName, ...rest } = props;
  ...
  return (
    <div className={clsx(props.className, classes.root)} {...rest}>
