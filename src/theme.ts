...
export const THEME_HEADER_HEIGHT: string = "9rem";
export const THEME_HEADER_HEIGHT_MD: string = "8rem";
 ...
 */
export const colorConfigs: { [key: string]: ColorConfig } = {
...
export type GetColorConfigFromPalette = (palette: string) => ColorConfig;
 ...
 */
export const getColorConfigFromPalette: GetColorConfigFromPalette = (
  palette
) => {
